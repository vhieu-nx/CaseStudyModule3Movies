...
public class DynamicConnectionPoll {
    private static final Logger LOGGER = LogManager.getLogger(DynamicConnectionPoll.class);
    ...
    private static final DynamicConnectionPoll instance = new DynamicConnectionPoll();
    private final BlockingQueue<ProxyConnection> freeConnections;
    private final BlockingQueue<ProxyConnection> givenAwayConnections;

    private static final Lock locker = new ReentrantLock();

    private DynamicConnectionPoll() {
        try {
    ...
    public static DynamicConnectionPoll getInstance() {
        return instance;
    }
